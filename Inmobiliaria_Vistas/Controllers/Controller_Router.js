 AppAngular.config(function($stateProvider, $locationProvider, $urlRouterProvider, $httpProvider) {	
    ...
    $stateProvider
        .state('/home', {
        ...
        }).state('/inm_comisiones', {
            url: "/inm_comisiones",
            views: {
                "lazyLoadView": {
                    controller: 'ControlComisiones', // This view will use AppCtrl loaded below in the resolve
                    templateUrl: "../inmueble/comisiones.html",
                }
            },
            resolve: {// Any property in resolve should return a promise and is executed before the view is loaded
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    // you can lazy load files for an existing module
                    return $ocLazyLoad.load('../../Controllers/Controller_Comisiones.js');
                }]
            }
            ...
            views: {
                "lazyLoadView": {
                    controller: 'ControlRegistroPersona', // This view will use AppCtrl loaded below in the resolve
                    templateUrl: "../empleados/registrar_empleado.html",
                }
            },
            resolve: {// Any property in resolve should return a promise and is executed before the view is loaded
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            ...
            views: {
                "lazyLoadView": {
                    controller: 'ControlConsultaEmpleado', // This view will use AppCtrl loaded below in the resolve
                    templateUrl: "../empleados/consultar_empleados.html",
                }
            },
            resolve: {// Any property in resolve should return a promise and is executed before the view is loaded
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    // you can lazy load files for an existing module
                    return $ocLazyLoad.load('../../Controllers/Controller_ConsultarEmpleados.js');
                }]
            }
        });
